    ...
    <>
      <section className="relative h-64 sm:h-80 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6 pt-20">
          <p className="text-[#D32323] text-[10px] tracking-[0.4em] uppercase mb-4">Book a Tour</p>
          ...
          <div className="flex flex-col gap-10">
            ...
            <ul className="flex flex-col gap-6">
              {COMPANY.phone ? (
                <li>
                  <a href={`tel:${COMPANY.phoneHref}`} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 border border-[#D32323]/30 flex items-center justify-center flex-shrink-0">
                      <Phone size={14} className="text-[#D32323]" />
                    </div>
                    <div>
                      <p className="text-[10px] tracking-[0.2em] uppercase text-foreground/40 mb-0.5">Text Us</p>
                      <p className="text-foreground group-hover:text-[#D32323] transition-colors">{COMPANY.phone}</p>
                    </div>
                  </a>
                </li>
              ) : null}
              {COMPANY.email ? (
                <li>
                  <a href={`mailto:${COMPANY.email}`} className="flex items-start gap-4 group">
                    <div className="w-10 h-10 border border-[#D32323]/30 flex items-center justify-center flex-shrink-0">
                      <Mail size={14} className="text-[#D32323]" />
                    </div>
                    <div>
                      <p className="text-[10px] tracking-[0.2em] uppercase text-foreground/40 mb-0.5">Email</p>
                      <p className="text-foreground group-hover:text-[#D32323] transition-colors">{COMPANY.email}</p>
                    </div>
                  </a>
                </li>
              ) : null}
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 border border-[#D32323]/30 flex items-center justify-center flex-shrink-0">
                  <MapPin size={14} className="text-[#D32323]" />
                </div>
                <div>
              ...
              <li className="flex items-start gap-4">
                <div className="w-10 h-10 border border-[#D32323]/30 flex items-center justify-center flex-shrink-0">
                  <Clock size={14} className="text-[#D32323]" />
                </div>
                <div>
            ...
            {(COMPANY.instagram || COMPANY.facebook) ? (
              <div className="flex gap-3">
                {COMPANY.instagram ? (
                  <a href={COMPANY.instagram} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 border border-border hover:border-[#D32323]/50 text-foreground/60 hover:text-[#D32323] text-xs transition-all">
                    <Camera size={13} /> Instagram
                  </a>
                ) : null}
                {COMPANY.facebook ? (
                  <a href={COMPANY.facebook} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-4 py-2.5 border border-border hover:border-[#D32323]/50 text-foreground/60 hover:text-[#D32323] text-xs transition-all">
